...
function THREETEST(props) {
    ...
    //  加载纹理
    const texture = textureLoader.load('../../../public/cback.jpeg')
    texture.colorSpace = THREE.SRGBColorSpace;
    //  加载环境遮挡贴图
    const aoMap = textureLoader.load('../../../public/back.jpeg')
    //  加载透明度贴图
    const alphaMap = textureLoader.load('../../../public/bback.jpeg')
    //  加载光照贴图
    const lightMap = textureLoader.load('../../../public/bback.jpeg')
    // 加载高光贴图
    const specularMap = textureLoader.load('../../../public/bback.jpeg')
    // 加载hdr贴图
    const rgbeLoader = new RGBELoader();
    rgbeLoader.load('../../../public/bback.jpeg ', (envMap) => {
        //  设置球形贴图
